...
static const char qt_meta_stringdata_QTest[] = {
    "QTest\0"
};
...
const QMetaObjectExtraData QTest::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTest::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTest,
      qt_meta_data_QTest, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTest::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTest))
